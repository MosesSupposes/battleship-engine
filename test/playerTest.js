...
describe('PLAYER METHODS', function () {
  describe('validateLocation', function () {
    var validateLocation = require('../game_logic/playerMethods.js').validateLocation;
    var player;
  ...
  describe('validateLocations', function () {
    var validateLocations = require('../game_logic/playerMethods.js').validateLocations;
    var player;
  ...
  describe('placeShip', function () {
    var placeShip = require('../game_logic/playerMethods.js').placeShip;
    var player;
    ...
    it('should throw an error if no direction is specified', function() {
      ...
      var handler = () => { placeShip(player, ship, coordinates); };
